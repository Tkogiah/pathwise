...
## 1 — Intake & Initial Engagement (Day 0–3)

**Stage Title:** Intake & Initial Engagement  
...
- Schedule initial housing planning meeting (By Day 3)

## 2 — Housing Assessment & Planning (Day 4–14)

**Stage Title:** Housing Assessment & Planning  
**Timeline Goal:** Day 4–14

**Subtasks:**

- Identify housing type(s) to pursue by priority:
  - Permanent Supportive Housing (PSH)
  - Rapid Rehousing (RRH)
  - Subsidized/Affordable Housing
  - Market-rate housing
- Develop individualized Housing Action Plan (By Day 10)
- Set realistic housing timeline and milestones aligned with 90-day limit (By Day 10)
- Review income sources and benefits status (By Day 14)
- Refer to benefits support if needed (SSI/SSDI, SNAP, GA, VA) (By Day 14)

## 3 — Documentation & Housing Readiness (Day 7–30)

**Stage Title:** Documentation & Housing Readiness  
**Timeline Goal:** Day 7–30
...
## 4 — Housing Search & Applications (Day 14–75)

**Stage Title:** Housing Search & Applications  
**Timeline Goal:** Day 14–75

**Subtasks:**

- Identify appropriate housing leads (Begin by Day 14; ongoing)
- Review eligibility requirements with participant (Ongoing)
- Assist with housing applications (online and paper) (Begin by Day 21)
- Track submitted applications and waitlists (Weekly)
...
- Review lease terms with participant (Prior to signing)
...
- Complete CSC exit planning checklist (By Day 75)
...
- Schedule follow-up if program requires post-exit check-ins
